...
def getTests():
	...
	testCase     = testTemplate.testInstance("1" , "-1" , "Smoke test case 1")
	defaultSuite.add(testCase)
	
	testCase     = testTemplate.testInstance("3" , "555" , "Smoke test case 2")
	defaultSuite.add(testCase)
	
	testCase     = testTemplate.testInstance("5" , "33333" , "Smoke test case 3")
	defaultSuite.add(testCase)
	
	testCase     = testTemplate.testInstance("11" , "55555533333" , "Smoke test case 4")
	defaultSuite.add(testCase)
