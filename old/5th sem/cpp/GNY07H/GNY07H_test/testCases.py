...
def getTests():
	...
	testCase     = testTemplate.testInstance("2" , "1 5" , "Smoke test case 1")
	defaultSuite.add(testCase)
	
	testCase     = testTemplate.testInstance("3" , "2 11" , "Smoke test case 2")
	defaultSuite.add(testCase)
	
	testCase     = testTemplate.testInstance("7" , "3 781" , "Smoke test case 3")
	defaultSuite.add(testCase)
