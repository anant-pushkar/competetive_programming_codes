...
def getTests():
	...
	testCase     = testTemplate.testInstance("3 00010" , "?" , "Smoke test case 1")
	defaultSuite.add(testCase)
	
	testCase     = testTemplate.testInstance("2 00010" , "?" , "Smoke test case 2")
	defaultSuite.add(testCase)
	
	testCase     = testTemplate.testInstance("5 00010" , "?" , "Smoke test case 3")
	defaultSuite.add(testCase)

	testCase     = testTemplate.testInstance("7 00010" , "?" , "Smoke test case 3")
	defaultSuite.add(testCase)
