...
def getTests():
	...
	testCase     = testTemplate.testInstance("2 2" , "3" , "Smoke test case 1")
	defaultSuite.add(testCase)
	
	testCase     = testTemplate.testInstance("3 2" , "7" , "Smoke test case 2")
	defaultSuite.add(testCase)
	
	testCase     = testTemplate.testInstance("2 3" , "9" , "Smoke test case 3")
	defaultSuite.add(testCase)
	
	testCase     = testTemplate.testInstance("4 4" , "3375" , "Smoke test case 4")
	defaultSuite.add(testCase)
