...
def getTests():
	...
	suite.add(testcase)
	testcase = testTemplate.regexTester("a_b__c" , "Error!" , "sample11")
	suite.add(testcase)
	testcase = testTemplate.regexTester("_fvdf" , "Error!" , "sample12")
	suite.add(testcase)
	testcase = testTemplate.regexTester("J" , "Error!" , "sample13")
	suite.add(testcase)
	tests.append(suite)
